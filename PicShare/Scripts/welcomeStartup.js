//$(document).ready(() => {
define(['knockout', 'vm/mainViewModel', 'vm/welcomeViewModel'],
    function (ko, mainViewModel, welcomeViewModel) {

        return function welcomeStartup() {
            self = this;
            ...
            self.init = function () {
                ...
                ko.applyBindings(new welcomeViewModel());
            };
